...
`)+`
`+p);const y=S+m+a,v=S+p+o,T=Ch(i,i.VERTEX_SHADER,y),w=Ch(i,i.FRAGMENT_SHADER,v);i.attachShader(g,T),i.attachShader(g,w),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function A(P){if(s.debug.checkShaderErrors){const F=i.getProgramInfoLog(g).trim(),D=i.getShaderInfoLog(T).trim(),k=i.getShaderInfoLog(w).trim();let X=!0,G=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(X=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,g,T,w);else{const Y=Ph(i,T,"vertex"),V=Ph(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
